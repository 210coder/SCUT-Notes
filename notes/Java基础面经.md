...
- Java的方法重写（父类与子类之间的多态） 一般情况指第二种

Java的多态是通过java虚拟机实现动态调用

![image-20220331102242486](Java基础面经/image-20220331102242486.png)
...
方法表保存的就是实例方法的引用，而且是直接引用。java虚拟机在执行程序的时候就是通过这个方法表来确定运行哪一个多态方法的。
